...
from wpimath.controller import LTVUnicycleController, PIDController
...
class PPHolonomicDriveController(PathFollowingController):
    ...
    _isEnabled: bool = ...
    _rotationTargetOverride: Union[Callable[[], Union[Rotation2d, None]], None] = ...
    _xFeedbackOverride: Union[Callable[[], float], None] = ...
    _yFeedbackOverride: Union[Callable[[], float], None] = ...
    _rotationFeedbackOverride: Union[Callable[[], float], None] = ...
    def __init__(
        self,
